...
module.exports = function (app) {
  ...
  app.get("/minidesserts", async (req,res) => {
    var menuItems = [
      ...
      { name: 'Mango Panna Cotta', description: 'Our take on a classic Italian dessert infused with fresh mangoes and saffron.' },
      ...
      { name: 'Triple Chocolate Mousse', description: '' },
