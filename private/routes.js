...
module.exports = function (app) {
  ...
  app.get("/minidesserts", async (req,res) => {
    var menuItems = [
      ...
      { name: 'Mini Cheesecake Bites', image: 'NoImage.png', description: 'Flavor options are chocolate, key lime & NY style.', allergens: 'dairy, eggs, and gluten.' }
    ]
  ...
  app.get("/tables", async (req,res) => {
    var menuItems = [
      ...
      { name: 'Mini Cream Puffs', image: 'MiniCreamPuffs.jpg', description: '$36/dozen', allergens: '' },
