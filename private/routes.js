...
module.exports = function (app) {
  ...
  app.get("/desidesserts", async (req,res) => {
    var menuItems = [
      { name: 'Rasmalai Tres Leches', image: 'RasmalaiTresLeches2.jpg', description: 'Sponge cake soaked in a malai mix scented with cardamom and pistachios, a Mexican favorite.', allergens: 'dairy, eggs, gluten, and nuts.' },
