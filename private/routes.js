...
module.exports = function (app) {
  ...
  app.get("/desidesserts", async (req,res) => {
    var menuItems = [
      { name: 'Rasmalai Tres Leches', image: 'RasmalaiTresLeches2.jpg', description: 'Our take on a Mexican favorite, sponge cake soaked in a malai mix scented with cardamom and pistachios.', allergens: 'dairy, eggs, gluten, and nuts.' },
